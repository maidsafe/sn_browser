...
export function setup () {
  ...
  if (request.url.startsWith('beaker:auth-popup-info-hover-icon'))
    return cb(path.join(__dirname, 'img/info-hover.svg'))
  if (request.url.startsWith('beaker:auth-popup-info-icon'))
    return cb(path.join(__dirname, 'img/info.svg'))
