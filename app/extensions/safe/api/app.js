...
module.exports.manifest = {
  ...
  isNetStateInit: 'promise',
  isNetStateConnected: 'promise',
  isNetStateDisconnected: 'promise',
  ...
  readGrantedPermissions: 'promise',
  getOwnContainer: 'promise',
  getOwnContainerName: 'promise',
 ...
 * .then((perms) => {
 *   console.log('JSON object representation of app container permmissions: ', perms);
 * });
 */
...
/**
 * Get the name of the app's own container generated by Authenticator
 * @name window.safeApp.getOwnContainerName
 *
 * @param {SAFEAppHandle} appHandle the app handle
 *
 * @returns {Promise<String>} the app's own container name
 *
 * @example
 * window.safeApp.getOwnContainerName(appHandle)
 *    .then((name) => console.log('Own Container name: ', name));
 */
module.exports.getOwnContainerName = (appHandle) => getObj(appHandle)
    .then((obj) => obj.app.getOwnContainerName());
